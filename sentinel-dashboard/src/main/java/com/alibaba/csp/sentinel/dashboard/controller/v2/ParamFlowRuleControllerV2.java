...
import com.alibaba.csp.sentinel.dashboard.rule.nacos.ParamFlowRuleNacosPublisher;
...
public class ParamFlowRuleControllerV2 {
    ...
    @Resource(name = "paramFlowRuleNacosProvider")
    private ParamFlowRuleNacosProvider ruleProvider;
    @Resource(name = "paramFlowRuleNacosPublisher")
    private ParamFlowRuleNacosPublisher rulePublisher;
    ...
    public Result<List<ParamFlowRuleEntity>> apiQueryAllRulesForMachine(@RequestParam String app,
        ...
        try {
            List<ParamFlowRuleEntity> rules = ruleProvider.getAvailableRules(app);
    ...
    private void publishRules(/*@NonNull*/ String app) throws Exception {
        ...
        rulePublisher.publishAvailable(app, rules);
    }
